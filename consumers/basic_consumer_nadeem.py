...
def process_message(log_file) -> None:
    ...
    with open(log_file, "r") as file:
        ...
        while True:
            ...
            if "Custom Message 3: Special event detected!" in message:
                print(f"ALERT: A special event was detected! \n{message}")
                logger.warning(f"ALERT: A special event was detected! \n{message}")
